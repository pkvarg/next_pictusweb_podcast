      ...
      <div className="bg-white/5 rounded-lg p-6 border border-white/10 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            rows={16}
            placeholder="<h1>What's new in FleetSync</h1>&#10;<p>...</p>&#10;&#10;<p style='color: #888; font-size: 12px;'><a href='{{UNSUBSCRIBE_URL}}'>Unsubscribe</a></p>"
          ...
          <p className="text-xs text-gray-500 mt-1">
            Use {'{{UNSUBSCRIBE_URL}}'} placeholder for the unsubscribe link. It will be replaced per recipient.
          </p>
        </div>
