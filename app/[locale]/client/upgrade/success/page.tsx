...
export default function UpgradeSuccessPage() {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-20 text-center">
      ...
      <h1 className="text-3xl font-light text-white mb-4">{t('upgradeSuccessTitle')}</h1>
      <p className="text-gray-400 text-lg font-light mb-8">{t('upgradeSuccessDescription')}</p>
