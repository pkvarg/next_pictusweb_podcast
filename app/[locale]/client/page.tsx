    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8 justify-between items-stretch w-full mb-8">
          <iframe
            ref={iframe1Ref}
            className="w-full lg:w-[48%] rounded-lg border border-purple-500/30 bg-gradient-to-br from-slate-800/80 to-purple-900/40 min-h-[400px] overflow-hidden"
        ...
        <iframe
          ref={iframe3Ref}
          className="w-full my-8 rounded-lg border border-purple-500/30 bg-gradient-to-br from-slate-800/80 to-purple-900/40 min-h-[600px] overflow-hidden"
