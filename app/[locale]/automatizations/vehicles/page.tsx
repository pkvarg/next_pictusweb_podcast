    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-slate-900 to-black text-white">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full opacity-20 animate-pulse"></div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-purple-900/40 to-pink-900/40 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          {/* <div className="mt-8 text-[20px] text-gray-400">
            <p>✓ Bez záväzkov • ✓ Setup zdarma • ✓ Zrušiteľné kedykoľvek</p>
          </div> */}
        </div>
      </section>
      <Footer />
